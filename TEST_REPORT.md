...
| :--- | :--- | :---: | :---: | :--- |
| **Hooks Contract** | PreInvocation Hook outputs valid AGY JSON schema | 🟢 PASSED | 81ms | Valid JSON schema with 1 injected steps. Execution speed: fast. |
...
| **Workspace Isolation** | Separates Project A and Project B while preserving Global User profile | 🟢 PASSED | 171ms | Project A and Project B contexts are strictly isolated; Global profile is shared 100%. |
| **Memory Palace** | Palace generator builds interactive HTML with all live projects & git timeline | 🔴 FAILED | 1515ms | Palace HTML is missing key dashboard headers |
| **Git Versioning** | Memory changes can be audited with git log and rolled back cleanly | 🟢 PASSED | 109ms | Successfully proved Git revert and rollback capability. Base hash: 325112c |
| **AGY Plugin Schema** | Plugin passes 'agy plugin validate' with zero errors | 🟢 PASSED | 53ms | Native AGY plugin validation: 7 skills, 2 hooks processed with 0 errors. |
