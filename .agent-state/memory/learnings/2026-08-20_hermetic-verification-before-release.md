...
Final release-candidate evidence for `1.12.1`: 11/11 integration scenarios, 18/18 Node tests, direct AGY schema validation, scoped live global/project imports, local bare-remote push/pull, disposable-HOME root/direct lifecycle coverage, and 77.55% line / 58.46% branch / 78.14% function coverage. These checks do not prove external-network, cron, host sandbox enforcement, or remote runtime dependency closure.
